...
const MONGODB_URI = `mongodb+srv://fullstack:admin@123$admin@123@cluster0.7oyun.mongodb.net/graphql?retryWrites=true&w=majority`
console.log('Server active', MONGODB_URI)
